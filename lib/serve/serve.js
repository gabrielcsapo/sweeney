  ...
  return new Promise(function (resolve, reject) {
    const server = http.createServer(async (req, res) => {
      ...
      try {
        ...
        if (parsedFileName && watch !== undefined) {
          const parsedFile = site.rendered[parsedFileName]

          let contents = parsedFile.rendered
    ...
    return `
                            <li class="editable-container__item-list-item">
                              ...
                              <input class="editable-container__item-list-item__input" type="${editable[template][variableName].type}" placeholder="${variableName}" name="${variableName}" value="${editable[template][variableName].value}"/>
                            </li>
                          `
  }).join('')}
                      </ul>
              ...
              developmentToast.className = 'development-toast';
          ...
          const contents = await readFile(fullPath, 'binary')
