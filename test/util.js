...
test('util', (t) => {
  ...
  t.test('@escapeRegexValues', (t) => {
    ...
    t.test('should escape ? and ! properly', (t) => {
      const output = escapeRegexValues('What?!')
      t.equal(output, 'What\\?\\!')
      t.end()
    })
  ...
  t.test('@parseString', (t) => {
    ...
    t.test('should be able to parse tags', async (t) => {
...
`)
    ...
    t.test('should work with an empty template', async (t) => {
